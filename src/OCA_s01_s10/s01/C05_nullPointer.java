...
public class C05_nullPointer {
   ...
   /*int x=0;
   String s=null;
   if(x==s) System.out.println("sucses");
        ...
        String str1;          String str2= new String();            String str3= "";          String str4=null;
        //System.out.println(str4);

        // bir String'e deger atayabiliriz
        str1="java";  str2="java"; str3="java";  str4="java";
        ...
        // null atamasi yaptigimiz String yazdirildiginda null sonucunu goruruz . bu bir String degil, sadece str4'e null atandiginin isaretidir
